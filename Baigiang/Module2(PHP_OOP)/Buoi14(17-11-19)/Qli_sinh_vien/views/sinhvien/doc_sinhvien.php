...
<body>
    <div class="container-fluid">
        <div class="row">
            <div class="col-12 border border-primary pt-2">
                <img src="public/images/logoT3h.png" class="img-fluid float-left ml-5" alt="Lập trình viên PHP">
    ...
    <div class="container text-center text-danger">
        <div class="row">
            ...
            <h3 class="card-title text-success">Thông tin sinh viên</h3>
            </div>
        </div>
    </div>
    <div class="container">
                ...
                <div class="card border">
                    <div class="card-body">
                        <div class="card mb-1 p-2">
                            <div class="card-body">
                                <h4 class="card-title">Họ tên: <?php echo $sinhvien->tensv; ?></h4>
                                <span class="text-danger">Lớp: <?php echo $sinhvien->lop; ?>  </span>
                                <hr>
                            </div>
                        </div>
                    </div>
