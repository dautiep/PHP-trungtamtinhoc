                ...
                <div class="card border">
                    <div class="card-body">
                        <form method="POST" action="" enctype="multipart/form-data">
                            <input type="file" name="Th_file" id="Th_file" onchange="Xem_truoc_Media()"/>
                            <img id="Th_Hinh_Xem_truoc" width="80px" />
                            <div class="form-group text-center">
                                <button type="submit" class="btn btn-outline-danger" name="uploadclick">Upload</button>
                            </div>
                        </form>
