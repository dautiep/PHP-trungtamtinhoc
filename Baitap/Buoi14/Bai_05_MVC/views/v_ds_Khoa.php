...
<body>
    ...
    <div class="container text-center text-danger">
        <div class="row">
            ...
            <h3 class="card-title text-success">Danh sách Khoa</h3>
            </div>
        </div>
    </div>
    <div class="container">
                    ...
                    <table class="table table-striped table-inverse table-responsive mt-2">
                        ...
                        <tbody>
                            <?php foreach($ds_khoa as $khoa): ?>
                                <tr>
                                <td scope="row"><?php echo $khoa->makhoa ?></td>
                                <td><?php echo $khoa->tenkhoa; ?></td>
                                <td><a class="btn btn-sm btn-outline-primary">Xem chi tiết</a></td>
                                </tr>
                            <?php endforeach ?>
                        </div>
                        </tbody>
