...
try {
    ...
    $sql = "select sv.*,tenkhoa from sinhvien sv inner join khoa k on sv.makhoa=k.makhoa where sv.makhoa=?";
    $sta = $conn->prepare($sql);
    $makhoa=1;
    $ds_tham_so=array($makhoa);
...
<body>
    ...
    <div class="container text-center text-danger">
        <div class="row">
            ...
            <h3 class="card-title text-success">Danh sách Sinh viên Khoa Công nghệ Thông tin</h3>
            </div>
        </div>
    </div>
    <div class="container">
