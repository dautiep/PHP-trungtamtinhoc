...
<?php
    ...
    $sta->execute();
    $ds_Sinh_vien = $sta->fetchAll(PDO::FETCH_ASSOC);
?>
<body>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card border">
                    <div class="card-body">
                        <h3 class="card-title text-success">Sử dụng PDO - Đọc Danh sách Sinh viên - Hiển thị dạng bảng</h3>
                        <table class="table table-striped table-inverse table-responsive mt-2">
                            <thead class="thead-inverse">
                                <tr>
                                    <th nowrap>#</th>
                                    <th nowrap>Họ tên Sinh viên </th>
                                    <th nowrap>Lớp</th>
                                </tr>
                            </thead>
                            <tbody>
                            ...
                            ?>    
                                <tr>
                                    <td scope="row"><?php echo $sv["masv"]; ?></td>
