  ...
  <body>
    <?php
        ...
        if(isset($_POST["submit"])){
            $a_nhap = $_POST["th_soa"];
            $b_nhap = $_POST["th_sob"];
            //kiểm tra xem có nhập đủ hai số a, b hay không
            if(empty($a_nhap) || empty($b_nhap))
                $err = 'Note: Bạn phải nhập đủ hai số a, b!!';
            else{
                $a = $_POST["th_soa"];
                $b = $_POST["th_sob"];
                if(!is_numeric($a) || !is_numeric($b))
                    $err ='Note: a, b phải là một số nguyên';
                else{
                    if ($a == 0 || $b == 0){
                    $ucln = $a + $b;
                    }
    ...
    ?>
    <div class="container">
        <h2>Tìm UCLN và BCNN của hai số</h2>
        <div class="row">
            <div class="col-md-12">
                <form method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="th_ketqua" readonly="readonly" value="<?php echo $ucln; ?>">
                    </div>
                    <div class="form-group">
